...
void TerrainMeshGrid::readerTransactionTry(const AABB &region, const std::function<void(const TerrainMesh &terrainMesh)> &onPresent) const
{
    ...
    private:
        ...
        boost::optional<std::reference_wrapper<const TerrainMesh>> _ref;
    ...
    public:
        ...
        {
            _ref = boost::optional<std::reference_wrapper<const TerrainMesh>>(terrainMesh);
        }
    };
